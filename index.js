...
console.log('ready')
 ...
 axios.get("https://disastrouswastefulcallbacks.jahmoment.repl.co/add?url="+`https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER}.repl.co/`).catch((err)=>{console.log("pinger down?")})
